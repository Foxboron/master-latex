...
dissertation \citetitle{david-a.-wheeler-2009} details a possible solution to
the ``trusting trust''-problem. It involves what he call diverse ``diverse
compilation'' \cite{david-a.-wheeler-2009}.
...
The reproducible builds effort has yearly summit where the participants from the
project come together and discuss issues and problem in the project
...
\begin{figure}
\centering
\subfloat[audit proof for ``d5'']{\begin{tikzpicture}
\Tree
[ .\node[root]{r};
[ .m   [ .i d1 d2 ]  [ .j d3 d4 ]  ]
...
\end{tikzpicture}}%
\qquad
\subfloat[needed roots for audit proof]{\begin{tikzpicture}
\Tree
[ .\node[root]{r};
