...
% \begin{listing}[htpb]
% \caption{Example python code for audit path}
% \label{lst:audit_path_algorithm}
% \begin{minted}{python}
% def audit_path(node):
...
Listing~\ref{lst:entrydefinitions} displays the fields in a sort of structure
with some type information. ``InclusionEntry'' and ``RevokeEntry'' are both
composite structures from the main ``Entry'' definition. This
